    ...
    return (
        <div style={style}>
            ...
            <ul>
                ...
                <li>Please cite <a target="_blank" rel="noopener noreferrer" href="https://doi.org/10.5281/zenodo.2656630">10.5281/zenodo.2656630</a> if you use the software like this site or the <a target="_blank" rel="noopener noreferrer" href="https://github.com/iomega/paired-data-form/blob/master/manuals/developers.md#web-service">web service</a>.</li>
            </ul>
        </div>
    );
}