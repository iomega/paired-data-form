...
export const CheckList = () => (
    <div>
        ...
        <ul>
            <li>Deposit your metabolomics data in <a target="_blank" href="https://gnps.ucsd.edu/">MASSive</a> or <a target="_blank" href="https://www.ebi.ac.uk/metabolights/">MetaboLights</a> and make the data publically available</li>
            <li>Deposit your assembled genomes/metagenomes in a public database (<a target="_blank" href="https://www.ncbi.nlm.nih.gov/genbank/">GenBank</a>, <a target="_blank" title="European Nucleotide Archive" href="https://www.ebi.ac.uk/ena">ENA</a>, <a target="_blank" title="DNA Data Bank of Japan" href="https://www.ddbj.nig.ac.jp/ddbj/index-e.html">DDBJ</a>, <a target="_blank" title="Integrated Microbial Genomes & Microbiomes - Joint Genome Institute" href="https://img.jgi.doe.gov/">IMG-JGI</a> or <a target="_blank" title="EBI Metagenomics" href="https://www.ebi.ac.uk/metagenomics/">MGnify</a>) and make them publically available</li>
        ...
        <ul>
            <li>
                Deposit the gene cluster in <a target="_blank" href="https://mibig.secondarymetabolites.org/">MIBiG</a> and have the accession number available</li>
            <li>
                Have the SMILES (textual representation of the chemical structure) of the metabolites available</li>
            <li>
                Locate the MS2 scan or molecular family ID in <a target="_blank" href="https://gnps.ucsd.edu/">GNPS</a></li>
        </ul>
        <p>Pro Tips:</p>
        <ul>
