...
export function ProjectForm({ onSubmit, formData }: IProps) {
  ...
  const onWrappedSubmit = (
    event: ISubmitEvent<IOMEGAPairedOmicsDataPlatform>
  ) => {
        ...
        >
          {uploadError && (
            <Alert bsStyle="danger">
              ...
              with an <a href="https://jsonschemalint.com/">online tool</a>{" "}
              against the{" "}
              <a target="_blank" href="/public/schema.json">
                JSON schema
              </a>
              .
            </Alert>
          ...
          <div>
            ...
            <a href="https://doi.org/10.5281/zenodo.3736430">dataset</a>.
          </div>
          <ButtonToolbar>
            <ButtonGroup>
