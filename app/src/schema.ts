...
/**
 * Identifier of the project. Generated by the paired omics data platform
 */
...
/**
 * Add other associated GNPS-MassIVE identifiers here, eg. MSV000078836,MSV000078839. For example, if you have data spread out over multiple MASSIVE projects, reported in the same publication, you can add those related IDs here. If you used the same assays ("Sample Preparation," "Extraction Methods," and/or "Instrumentation Methods"), you can clone one project and make slight modifications (e.g. different Genome IDs) instead of entering the assay information again.
 */
export type RelatedGNPSMassiveIdentifiers = string;
/**
 * Add other associated MetaboLights study identifiers here, eg. MTBLS727,MTBLS728. For example, if you have data spread out over multiple MetaboLights studies, reported in the same publication, you can add those related IDs here. If you used the same assays ("Sample Preparation," "Extraction Methods," and/or "Instrumentation Methods"), you can clone one project and make slight modifications (e.g. different Genome IDs) instead of entering the assay information again.
 */
export type RelatedGNPSMassiveIdentifiers1 = string;
/**
...
/**
 * Please enter the length of growth time in hours.
 */
export type GrowthTime = number;
/**
 * Please enter the growth phase or OD if you know it.
 */
...
export interface OverallMetabolomicsProjectDetails {
  ...
  related_metabolights_study_id?: RelatedGNPSMassiveIdentifiers1;
