...
describe('with schema loaded', () => {
    ...
    describe('textTable', () => {
        it('should convert minimal json doc to text table', () => {
            ...
            const expected = [
                ["Location of metabolomics data file", "Genome or Metagenome", "GenBank accession number", "RefSeq accession number", "ENA/NCBI accession number", "MGnify accession number", "BioSample accession number", "Key publications", "Medium type", "Growth medium", "Growth temperature", "Aeration", "Growth time", "Growth phase or OD", "Other growth conditions", "Metagenome details", "Metagenomic sample description", "Sample Growth Conditions Label", "Extraction solvent", "Other extraction details", "Extraction Method Label", "Instrumentation", "Column details", "Instrument mode", "Mass range", "Collision energy", "Buffering", "Other instrumentation information", "Instrumentation Method Label"]
            ];
    ...
    describe('tsvUrl', () => {
        it('should render doc with no links as just header', () => {
            ...
            const expected = 'data:text/tab-separated-values;base64,';
